...
const formArchetypes = [
    ...
    families: [
  {
    ...
    name: "Classic House",
    bpm: "120–130",
    structuralProfile: "Чотирибитна петля як основа; треки будуються через пошарування елементів: хай-хет, перкусія, басова лінія, вокальний семпл. Форма — це тривалий аддитивний та субтрактивний процес без чіткого кульмінаційного моменту.",
    energyProfile: "Енергія рівномірна і гіпнотична; підйоми та спади виконуються фільтрацією та мікс-інами. Танцпол підтримується постійним грувом, а не драматичними перепадами.",
    canonicalTracks: [
      "Larry Heard — Can You Feel It (1986)",
      "Marshall Jefferson — Move Your Body (1986)",
      "Frankie Knuckles — Your Love (1987)",
      "Ten City — That's the Way Love Is (1987)",
      "Jamie Principle — Your Love (1985)"
    ],
    commonMistakes: [
      "Занадто швидке введення всіх елементів — губиться відчуття будови та очікування.",
      "Ігнорування ролі тиші та пустоти: класичний хаус дихає паузами.",
      "Перенасичення звуків замість мінімальної, але потужної текстури."
    ],
    distinguishingFeatures: [
      "Чотири-на-підлозі кік з характерним звуком Roland TR-909 або TR-808.",
      "Вокальний семпл або хор як емоційний центр треку.",
      "Органічний, «теплий» мікс без агресивної компресії.",
      "Відчуття спільноти й духовності у звуці — коріння чорної квір-культури Чикаго."
    ]
  },
  {
    id: "deep-house",
  ...
  },
  {
    ...
    name: "Detroit Techno",
    bpm: "130–150",
    structuralProfile: "Машинний та індустріальний характер; структура мінімальна, але насичена текстурою — повторювані петлі з поступовою еволюцією тембру. Форма ближча до musique concrète, ніж до поп-пісні.",
    energyProfile: "Холодна, механічна і невблаганна; не ейфорична, а гіпнотична. Слухач підпадає під ритмічний транс, відчуваючи антиутопійне місто майбутнього.",
    canonicalTracks: [
      "Juan Atkins — No UFOs (1985)",
      "Derrick May — Strings of Life (1987)",
      "Kevin Saunderson — Big Fun (1988)",
      "Model 500 — Night Drive (1985)",
      "Underground Resistance — Electronic Warfare (1991)"
    ],
    commonMistakes: [
      "Намагатися зробити detroit-techno «теплим» або «мелодичним» — його краса в індустріальній холодності.",
      "Забувати про фанк-основу: попри механіку, Детройт — це чорна музика з душею.",
      "Перевантажувати частоти без динамічного контрасту — трек губить гіпноз."
    ],
    distinguishingFeatures: [
      "Футуристична естетика — звук машин, синтезаторів і міста.",
      "Соціальний коментар у корінні: відповідь на занепад Детройту.",
      "Суміш людського та механічного — складний грув усередині жорсткої сітки.",
      "Мінімальна мелодія, але максимальна атмосфера."
    ]
  },
  {
    id: "minimal-techno",
  ...
  },
  {
    ...
    name: "Dub Techno",
    bpm: "130–138",
    structuralProfile: "Синтез дабу й техно; структура базується на повторюваних петлях із глибоким реверб-еко, характерним для ямайської дабової традиції. Форма еволюціонує через накладання та видалення хвильових «відлунь».",
    energyProfile: "Занурювальна й медитативна; не ейфорична, а спіритуальна. Слухач відчуває простір і час по-іншому — трек «дихає» через дабові затримки.",
    canonicalTracks: [
      "Basic Channel — Phylyps Trak (1993)",
      "Basic Channel — Quadrant Dub (1994)",
      "Deepchord — Sommer (2009)",
      "Varg — Ful Av Liv (2018)",
      "Monolake — Hongkong (1997)"
    ],
    commonMistakes: [
      "Перевантажити реверб і еко — трек тоне у звуці, втрачаючи чіткість.",
      "Не приділяти достатньої уваги стерео-простору: дабове техно живе у просторі.",
      "Занадто прості петлі без тонкого темперування тембру."
    ],
    distinguishingFeatures: [
      "Дабові затримки та реверб як структурні елементи, не лише ефекти.",
      "Металічний, «мокрий» звук кіка і клапу.",
      "Атмосферні падди, що розчиняються в просторі.",
      "Спіритуальна взаємодія між звуком і тишею."
    ]
  },
  {
    id: "uplifting-trance",
    name: "Транс (Uplifting)",
    bpm: "136–145",
    structuralProfile: "Найбільш структурований варіант клубної дуги; форма має чіткі секції з тривалим наростанням, брейкдауном (де вводиться мелодія) та кульмінаційним дропом. Формула 8- або 16-тактових фраз витримана майже ідеально.",
    energyProfile: "Максимально ейфорична; кульмінація провокує фізичну й емоційну реакцію — «руки вгору». Емоційна подорож від нуля до абсолютного піку.",
    canonicalTracks: [
    ...
    commonMistakes: [
      "Занадто предбачувана формула — слухач вимикається ще до дропу.",
      "Слабка мелодія у брейкдауні: трек живе або вмирає на цьому моменті.",
      "Надмірна компресія на дропі — ейфорія потребує динаміки, а не гучності."
    ],
    distinguishingFeatures: [
      "Чіткий брейкдаун з мелодичною темою та наростанням напруги.",
      "Ейфоричний дроп як структурна й емоційна кульмінація.",
      "Суперсо (supersaws) та атакуючі синтезатори як характерний тембр.",
      "Темп 138–142 BPM як ідеальна зона транс-стану."
    ]
  },
  {
    id: "psytrance",
  ...
  },
  {
    ...
    name: "Deep Dubstep",
    bpm: "138–142",
    structuralProfile: "Форма базується на напівтемпі (half-time): кік звучить на третьому бітові замість першого, що створює враження повільного, важкого руху. Простір між ударами — така ж частина структури, як і самі удари.",
    energyProfile: "Важка, задушлива, але глибока; не агресивна, а атмосферна. Слухач відчуває тиск і простір одночасно — це музика темряви й інтроспекції.",
    canonicalTracks: [
      "Burial — Archangel (2007)",
      "Mala — Left Leg Out (2006)",
      "Digital Mystikz — Anti-War Dub (2005)",
      "Loefah — Goat Stare (2006)",
      "Skream — Please (2005)"
    ],
    commonMistakes: [
      "Забувати про простір: deep dubstep «дихає» паузами, а не заповнює їх.",
      "Робити сабвуфер занадто «чистим» — характерний «брудний» суббас є ідентичним маркером.",
      "Плутати з бростепом: deep dubstep — це атмосфера, а не агресія."
    ],
    distinguishingFeatures: [
      "Half-time ритмічна структура — кік на третьому бітові замість першого.",
      "Важкий «розмитий» суббас як головний ритмічний і мелодичний елемент.",
      "Атмосферні семпли та вокальні фрагменти як текстура.",
      "Темп 138–140 BPM як half-time еквівалент 69–70 BPM."
    ]
  },
  {
    id: "brostep",
  ...
  },
  {
    ...
    name: "Нейрофанк",
    bpm: "172–180",
    structuralProfile: "Технічно складна й темна форма D&B; структура зосереджена навколо мутуючого Reese-басу та складного барабанного малюнка. Форма менш мелодична, ніж liquid, і більше орієнтована на звуковий дизайн як основний наратив.",
    energyProfile: "Інтелектуально насичена й атмосферно темна; не ейфорична, а занурювальна. Слухач відчуває технологічну складність як форму краси.",
    canonicalTracks: [
      "Optical — To Shape The Future (1998)",
      "Ed Rush & Optical — Bacteria (1998)",
      "Noisia — Machine Gun (2009)",
      "Phace — Chain Smoker (2010)",
      "Ulterior Motive — Graft (2012)"
    ],
    commonMistakes: [
      "Надмірно складний Reese-бас без структурного контексту — звуковий дизайн має служити формі.",
      "Ігнорувати ритмічну варіативність: нейрофанк — це не лише бас, а й барабани.",
      "Плутати темноту з монотонністю — жанр повинен дивувати і нові ідеї всередині структури."
    ],
    distinguishingFeatures: [
      "Мутуючий, багатошаровий Reese-бас як центральний елемент.",
      "Складний синкопований барабанний малюнок з нестандартними акцентами.",
      "Мінімальна мелодія — акцент на тембрі та звуковому дизайні.",
      "Темна, технологічна атмосфера як емоційний простір жанру."
    ]
  }
]
  },
    ...
    familiesHtml = `
      <div class="depth-block">
        <h4 class="depth-heading" onclick="toggle('showFamilies')">
          🎛 Сімейства реалізацій ${state.showFamilies ? '▲' : '▼'}
        </h4>
        ${state.showFamilies ? `<div class="families-list">${f.families.map(fam => `
          <div class="family-card">
            ...
            <p class="family-structural"><em>Структура:</em> ${fam.structuralProfile}</p>
            <p class="family-energy"><em>Енергія:</em> ${fam.energyProfile}</p>
            <div class="family-tracks">
              <strong>Канонічні треки:</strong>
              <ul>${fam.canonicalTracks.map(t => `<li>${t}</li>`).join('')}</ul>
            </div>
            <div class="family-features">
              <strong>Відмінні ознаки:</strong>
              <ul>${fam.distinguishingFeatures.map(feat => `<li>${feat}</li>`).join('')}</ul>
            </div>
            <div class="family-mistakes">
