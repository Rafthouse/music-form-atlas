...
function renderLeftPanel() {
  ...
  html += `<div class="panel-section form-section"${formDimmed}>
    <h3 class="panel-heading">${t('formArchetypes')} <span class="form-hint">${t('formHint')}</span></h3>
    <div class="form-list">`;
    ...
    familiesHtml = `
      <div class="depth-block">
        <h4 class="depth-heading" onclick="toggle('showFamilies')">
          ${t('familiesHeading')} ${state.showFamilies ? '▲' : '▼'}
        </h4>
        ${state.showFamilies ? `<div class="families-list">${f.families.map(fam => `
          <div class="family-card">
            ...
            <p class="family-structural"><em>${t('structureLabel')}</em> ${fam.structuralProfile}</p>
            <p class="family-energy"><em>${t('energyLabel')}</em> ${fam.energyProfile}</p>
